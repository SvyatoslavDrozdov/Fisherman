...
Следующие пункты зациклены и работают в течение заранее заданного времени. Для извлечения информации из игры программа делает скрины экрана, а далее, при помощи библиотек OpenCV и Ultralytics извлекает информацию о положении интересующих тел.
